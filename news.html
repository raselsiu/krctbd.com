			...
			<div class="auto-container">
				<div class="row clearfix">
					...
					<div class="news-block_one col-lg-4 col-md-6 col-sm-12">
						<div class="news-block_one-inner wow fadeInLeft">
							<div class="news-block_one-image">
								<a href="news-detail.html"><img src="assets/images/background/krct/news-02.jpg"
										alt="" /></a>
							</div>
							<div class="news-block_one-content">
								...
								<h5 class="news-block_one-heading samir_bangla"><a href="news-detail.html">
										বই উৎসব!
									</a></h5>
					...
					<div class="news-block_one col-lg-4 col-md-6 col-sm-12">
						<div class="news-block_one-inner wow fadeInLeft">
							<div class="news-block_one-image">
								<a href="news-detail.html"><img src="assets/images/background/krct/salman-dua-02.jpg"
										alt="" /></a>
							</div>
							<div class="news-block_one-content">
								<ul class="news-block_one-meta">
					...
					<div class="news-block_one col-lg-4 col-md-6 col-sm-12">
						<div class="news-block_one-inner wow fadeInLeft">
							<div class="news-block_one-image">
								<a href="news-detail.html"><img src="assets/images/background/krct/tour-02.jpg"
										alt="" /></a>
							</div>
							<div class="news-block_one-content">
								<ul class="news-block_one-meta">
								...
								<!-- Styled Pagination -->
								<!-- <ul class="styled-pagination text-center mtb_50">
