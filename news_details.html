						...
						<div class="blog-detail">
							<div class="blog-detail_outer">
								<div class="blog-detail_image">
									<img src="assets/images/background/krct/news-01.jpg" alt="">
								</div>
								<div class="blog-detail_content">
									...
									<h3 class="blog-detail_heading samir_bangla" style="font-size: 35px;">বই উৎসব!</h3>
									<p class="samir_bangla">বই উৎসব!
										খুলাফায়ে রাশেদীন চ্যারিটির তত্বাবধানে পরিচালিত হযরত আবু বকর (রাঃ) একাডেমি & ট্রেনিং ইনস্টিটিউটে শিক্ষার্থীদের মধ্যে বই বিতরণ করেন চ্যারিটির ব্যাবস্থাপনা পরিচালক ইঞ্জি: আজহার উদ্দীন কাওছার, সুলতানপুর এলাকার তরুণ সমাজসেবক ও শিক্ষানুরাগী তানভীর আহমেদ কে.আর.সি এর তত্বাবধায়ক মুশাহিদ আলি, নূরানী শিক্ষক জাবের আল মাহমুদ ও হাফিজ ইমাদ উদ্দিন প্রমুখ। </p>
								</div>
								<div class="blog-detail_image">
									<img src="assets/images/background/krct/news-02.jpg" alt="">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="sidebar-side col-lg-4 col-md-12 col-sm-12">
						<aside class="sidebar">
							...
							<div class="sidebar-widget search-box">
								<form method="post" action="https://themazine.com/html/alquran/contact.html">
								...
								<div class="widget-content">
									...
									<div class="content">
										<ul class="category-list">
											<li><a href="#">Free Medical Camp<span>10</span></a></li>
										</ul>
									</div>
								</div>
							</div>
